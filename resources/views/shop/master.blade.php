...
<script type="text/javascript" src="{{asset('shop/js/jquery.smartmenus.js')}}"></script>
<!-- SmartMenus jQuery Bootstrap Addon -->
<script type="text/javascript" src="{{asset('shop/js/jquery.smartmenus.bootstrap.js')}}"></script>
<!-- To Slider JS -->
<script src="{{asset('shop/js/sequence.js')}}"></script>
<script src="{{asset('shop/js/sequence-theme.modern-slide-in.js')}}"></script>
<!-- Product view slider -->
<script type="text/javascript" src="{{asset('shop/js/jquery.simpleGallery.js')}}"></script>
<script type="text/javascript" src="{{asset('shop/js/jquery.simpleLens.js')}}"></script>
<!-- slick slider -->
<script type="text/javascript" src="{{asset('shop/js/slick.js')}}"></script>
<!-- Price picker slider -->
